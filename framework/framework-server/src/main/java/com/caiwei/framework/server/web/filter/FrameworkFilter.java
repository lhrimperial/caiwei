package com.caiwei.framework.server.web.filter;


import com.caiwei.framework.server.cache.CacheManager;
import com.caiwei.framework.server.cache.ICache;
import com.caiwei.framework.server.context.*;
import com.caiwei.framework.server.shared.define.Definitions;
import com.caiwei.framework.server.shared.define.LocaleConst;
import com.caiwei.framework.server.shared.define.Protocol;
import com.caiwei.framework.server.shared.entity.IUser;
import com.caiwei.framework.server.web.session.ISession;
import com.caiwei.framework.server.web.xss.ParametersValidator;
import com.caiwei.framework.server.web.xss.ParametersValidatorException;
