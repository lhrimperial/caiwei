package com.caiwei.framework.server.cache.message;

import com.caiwei.framework.server.cache.DefaultStrongCache;
import com.caiwei.framework.server.cache.provider.IBatchCacheProvider;
